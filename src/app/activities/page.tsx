          ...
          {activitiesData.map((activity, index) => (
            <li key={activity.id} className="border-b border-rule group" data-reveal="" style={revealDelay(Math.min(index, 5))}>
              <a
                ...
                className="grid grid-cols-[1fr_auto] md:grid-cols-12 gap-4 md:gap-8 py-5 md:py-6 items-baseline cursor-pointer transition-colors hover:bg-rule/30 active:bg-rule/40"
              >
