      ...
      <ul className="border-t border-foreground">
        {selectedAwards.map((award) => (
          <li key={award.id} className="border-b border-rule group">
            ...
            >
              <span className="col-span-2 md:col-span-1 text-sm md:text-base font-mono tabular-nums text-foreground-muted">
                {award.year}
              </span>
              ...
              <span className="col-span-2 md:col-span-1 md:order-last flex justify-end text-foreground-muted group-hover:text-accent transition-all duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5">
